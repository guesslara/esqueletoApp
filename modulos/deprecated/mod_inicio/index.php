...
<div style="position: absolute;height: 25px;padding: 15px;background: #000;color: #fff;width: 100%;">
...
<div style="position: absolute;bottom: 0;height: 25px;padding: 15px;background: #000;color: #fff;width: 100%;">
	<div style="float: right;margin-right: 25px;color: #FFF;font-size: 12px;font-weight: bold;">Salir: <?=$_SESSION[$txtApp['session']['nombreUsuario']]." ".$_SESSION[$txtApp['session']['apellidoUsuario']];?></div>
</div>
<div id="transparenciaGeneral1" class="transparenciaGeneral" style="display:block;">
	<div id="divMensajeCaptura" class="ventanaDialogo">
		<div id="barraTitulo1VentanaDialogoValidacion" class="barraTitulo1VentanaDialogoValidacion">Seleccionar Modulo...<div id="btnCerrarVentanaDialogo"><a href="#" onclick="cerrarVentana('divMensajeCaptura')" title="Cerrar Ventana"><img src="../../img/close.gif" border="0" /></a></div></div>
...
?>
				<form name="proyecto" id="proyecto">
				<table width="96%" border="1" cellpadding="0" cellspacing="1" style="margin: 5px;background: #FFF;border: 1px solid #666;font-size: 12px;">					
					<tr>
						<th colspan=5 style="background: #000;color:#FFF;font-size: 14px;">Listado de proyectos</th>
			     
					</tr>
					<tr>
						<th style="border: 1px solid #666;background: #e1e1e1;"> # </th>
						<th style="border: 1px solid #666;background: #e1e1e1;"> Nombre del proyecto </th>			     						
					</tr>
<?
...
?>
					<tr>
						<td align="center" style="height: 15px;padding: 5px;"><input type="radio" name="radio" id="radio" value="<?=$row['id_proyecto'];?>"></td>
						<td align="center" style="text-align: left;height: 15px;padding: 5px;">&nbsp;<?=$row['nombre_proyecto']?></td>
					</tr>
<?
				}
?>
...
?>				
			...
			<div style="border: 1px solid #e1e1e1;height: 97%;width: 210px;float: left;position: relative;margin: 3px;">
				<table border=0 align="center" style="margin-top: 10px;">
					<tr>
						<th><input type="button" name="entra" id="entra" style="color: #000;width: 180px;height: 30px;padding: 5px; border: 1px solid #CCC;background: #f0f0f0;" value="Entrar" onclick="mss()"></th>
					</tr>
					<tr>
						<th><input type="reset" name="cancelar" id="cancelar" style="color: #000;width: 180px;height: 30px;padding: 5px; border: 1px solid #CCC;background: #f0f0f0;" value="Cancelar"></th>
					</tr>
				</table>
			</div>
		</div>
