...
?>
			...
			<table border="0" cellpading="1" cellspacing="1" width="800" style="background: #FFF;">
				...
				<tr>
					<td class="tituloFormD"># de Serie</td>
					<td><textarea name="num_serie" id="num_serie" cols="50" rows="4"><?=utf8_decode($rowE["num_serie"]);?></textarea></td>
				</tr>
                                <tr>
...
?>
			...
			<table border="0" cellpading="1" cellspacing="1" width="800" style="background: #FFF;">
				...
				<tr>
					...
					<td><textarea name="num_serie" id="num_serie" cols="50" rows="4" ></textarea></td>
				</tr>
				<tr>
					<td class="tituloFormD">Observaciones</td>
...
?>
				<tr class="estiloTr">				    
				    ...
				    <td class="estiloTdResultados" ><?=utf8_encode($si['num_serie']);?></td>
